...
Control {
    ...
    PathView {
        ...
        property int directions: ClimateModel.airflowDirections.directions
        property var availableDirections: ClimateModel.airflowDirections.availableDirections
        ...
        onCurrentIndexChanged: ClimateModel.airflowDirections.directions = availableDirections[currentIndex]
