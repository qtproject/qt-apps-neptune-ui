...
T.ComboBox {
    ...
    contentItem: T.TextField {
        ...
        font: control.font
        color: !control.editable && control.visualFocus ? Default.focusColor : control.NeptuneStyle.brightColor
        selectionColor: control.NeptuneStyle.accentColor
        selectedTextColor: control.NeptuneStyle.brightColor
        ...
        background: Rectangle {
            ...
            border.color: parent && parent.activeFocus ?  control.NeptuneStyle.accentColor : control.NeptuneStyle.darkColor
        }
    }
    ...
    background: Rectangle {
        ...
        color: !control.editable && control.visualFocus ? (control.pressed ? Default.focusPressedColor : Default.focusLightColor) :
            (control.down || popup.visible ? Default.buttonPressedColor : control.NeptuneStyle.darkColor)
    ...
    popup: T.Popup {
        ...
        background: Rectangle { color: control.NeptuneStyle.darkColor}
    }
}
